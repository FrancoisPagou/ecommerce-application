    ...
    <div class="login-box">
        <form class="login-form" action="{{ route('admin.login.post') }}" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <span style="color: red;">@if($errors->has('email') && $errors->first('email')) {{ $errors->first('email') }} @endif</span>                
            </div>
            <div class="form-group">
                <label class="control-label" for="password">Password</label>
                <input class="form-control" type="password" id="password" name="password" placeholder="Password">
                <span style="color: red;">@if($errors->has('password') && $errors->first('password')) {{ $errors->first('password') }} @endif</span>
            </div>
            <div class="form-group">
                <div class="utility">
